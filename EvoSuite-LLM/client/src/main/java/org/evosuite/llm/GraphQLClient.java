...
public class GraphQLClient {
    ...
    public Single<ApolloResponse<PromptQuery.Data>> promptSuggestSummaryQuery(String testcase){
        PromptQuery promptQuery = PromptQuery.builder().test(testcase).type("testsummary").build();
