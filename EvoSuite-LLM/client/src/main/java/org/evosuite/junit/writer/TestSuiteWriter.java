...
//        LoggingUtils.getEvoLogger().info("After Formatter, content is: " + formattedSource);
    ...
    protected String getHeader(String test_name, String scaffolding_name, List<ExecutionResult> results) {
        ...
        builder.append("/*");
        builder.append(NEWLINE);
        builder.append(" * This file was automatically generated by UTestGen and EvoSuite");
        builder.append(NEWLINE);
    ...
    protected String testToString(int number, int id, ExecutionResult result, Boolean toImprove) {
        ...
        // ---------   start with the body code first -------------------------
        ...
        // ---------   prepare the signature and test method name -------------------------
        ...
        String testSignature = testSignature(number, id, methodName);
        builder.insert(0, testSignature);
        ...
        // calling test summarization

        if (Properties.LLM_TEST_SUMMARY) {
            String testSummary = llmSummarization(builder.toString());
            builder.insert(0, testSummary);
        }
...
//        }
    ...
    private String llmSummarization(String string) {
        LLMValidator llm = new LLMValidator();
        String summary = llm.suggestSummary(string);
        StringBuilder builder = new StringBuilder();

        // Start the JavaDoc comment
        builder.append("\n/**\n");

        // Replace every '. ' with '.\n' to start a new line after each sentence
        summary = summary.replace(". ", ".\n");

        // Split the summary into lines and append each line prefixed with " * "
